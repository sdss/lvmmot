...
try:
    from lvmmot import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-lvmmot') or 'dev'
...
.. |lvmmot_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('lvmmot')
...
man_pages = [
    (master_doc, 'lvmmot', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/lvmmot'
